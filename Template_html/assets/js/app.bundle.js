...
/***/ (function(module, exports) {
	...
	var sweetAlerts = function sweetAlerts() {
		...
		$('#sweet_alerts_card').on('click.sweet-warning-cancel', '.sweet-warning-cancel', function (e) {
			e.stopPropagation();
			swal({
				title: "Cảnh báo: bạn đang muốn xóa?",
				text: "Bạn sẽ không thể khôi phục nếu thực hiện chức năng này!",
				type: "warning",
				showCancelButton: true,
				confirmButtonColor: '#DD6B55',
				confirmButtonText: 'Xóa, Tôi chắc chắn',
				cancelButtonText: "Không, nhầm lẫn!",
				closeOnConfirm: false,
				closeOnCancel: false
			}, function (isConfirm) {
				if (isConfirm) {
