<?php $__env->startSection('pageTitle', 'Notification'); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        <?php echo e(Breadcrumbs::render('notifications')); ?>
                ...
                <div class="col-xs-12">
                    <div class="card card-data-tables customer-table-wrapper">
                        <header class="card-heading">
                            <h2 class="card-title">List Notification</h2>
    ...
    <script>
        $(function () {
            $('#roomTable').DataTable({
                stateSave: true,
                serverSide: true,
                ajax: '<?php echo route('notifications.data'); ?>',
                processing:     "Loading...",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: function (data) {
                    ...
                    {data: 'status', targets: 'no-sort', 'searchable': false, orderable: false, render: function (data, type, row) {
                        switch (Number(data)){
                            case 0: status = 'Not Send'; classCss = 'label-warning'; break;
                            case 1: status = 'Sent'; classCss = 'label-success'; break;
                        }
