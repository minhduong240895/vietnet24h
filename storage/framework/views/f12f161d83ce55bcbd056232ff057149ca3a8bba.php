<?php $__env->startSection('pageTitle', 'Add Member'); ?>
    ...
    <div id="header_wrapper" class="header-md ecom-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        <h1><?php echo e(trans('Add member')); ?></h1>
                        <?php echo e(Breadcrumbs::render('members-create')); ?>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <header class="card-heading ">
                            <h2 class="card-title"><?php echo e(trans('Member information')); ?></h2>
                        </header>
                        <div class="card-body">
                            <?php echo Form::open(['route' => ['members.store'], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal']); ?>
