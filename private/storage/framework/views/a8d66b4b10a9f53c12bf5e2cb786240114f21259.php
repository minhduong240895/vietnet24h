...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/assets/css/vendor.bundle.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/assets/css/app.bundle.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/assets/css/theme-b.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/assets/css/customs.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/assets/css/select2.min.css')); ?>">
                        ...
                        <a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
								<span class="meta">
									<span class="avatar">
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo e(url('public/assets/img/profiles/user.png')); ?>" alt="" class="img-circle max-w-35">
                                        <?php endif; ?>
        ...
        <div id="logo_wrapper">
            <ul>
                <li class="logo-icon">
                    <a href="<?php echo e('/'); ?>">
                        <div class="logo">
                            <img src="<?php echo e(URL::asset('public/assets/img/logo/logo-icon@2x.png')); ?>" alt="Logo">
                        </div>
                    </a>
                </li>
                <li class="menu-icon">
...
<script src="<?php echo e(URL::asset('public/assets/js/vendor.bundle.js')); ?>"></script>
<script src="<?php echo e(URL::asset('public/assets/js/app.bundle.js')); ?>"></script>
<script src="<?php echo e(URL::asset('public/assets/js/select2.min.js')); ?>"></script>
<script>
