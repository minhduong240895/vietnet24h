<?php $__env->startSection('pageTitle', 'Chỉnh sửa tag'); ?>
    ...
    <div id="header_wrapper" class="header-md ecom-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        <h1><?php echo e(trans('Chính sửa tag')); ?></h1>
                        <?php echo e(Breadcrumbs::render('tags-edit', $data)); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php echo Form::open(['route' => ['tags.update', 'id' => $data->id], 'files' => true, 'method' => 'PUT', 'class' => 'form-horizontal']); ?>
