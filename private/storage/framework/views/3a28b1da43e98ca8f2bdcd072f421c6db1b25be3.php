    ...
    <div id="header_wrapper" class="header-md ecom-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        <h1><?php echo e(trans('Thêm mới thành viên')); ?></h1>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <header class="card-heading ">
                            <h2 class="card-title"><?php echo e(trans('Thông tin thành viên')); ?></h2>
                        </header>
                        <div class="card-body">
                            <?php echo Form::open(['route' => ['users.store'], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal']); ?>
                            ...
                            <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                <?php echo e(Form::label('password', 'Mật khẩu', ['class' => 'col-sm-2 control-label'])); ?>

                                <div class="col-sm-10">
                                    <input class="form-control" name="password" type="password" placeholder="<?php echo e(trans('Nhập mật khẩu')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                                <?php echo e(Form::label('password_confirmation', 'Nhập lại mật khẩu', ['class' => 'col-sm-2 control-label'])); ?>

                                <div class="col-sm-10">
                                    <input class="form-control" name="password_confirmation" type="password" placeholder="<?php echo e(trans('Nhập lại mật khẩu')); ?>">
                                    <?php if($errors->has('comfirm_password')): ?>
