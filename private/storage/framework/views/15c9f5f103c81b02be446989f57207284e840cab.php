<?php $__env->startSection('pageTitle', 'Thêm mới danh mục con'); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        <?php echo e(Breadcrumbs::render('topics-create')); ?>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <header class="card-heading ">
                            <h2 class="card-title"><?php echo e(trans('Thông tin danh mục con')); ?></h2>
                        </header>
                        <div class="card-body">
                            <?php echo Form::open(['route' => ['topics.store'], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal']); ?>
