<?php $__env->startSection('pageTitle', 'Thêm mới danh mục'); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        <?php echo e(Breadcrumbs::render('categories-create')); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php echo Form::open(['route' => ['categories.store'], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal']); ?>
