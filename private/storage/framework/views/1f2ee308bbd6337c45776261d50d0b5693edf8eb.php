                                    ...
                                    <?php $__currentLoopData = $listNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $New): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="news">
                                            <div class="col-sm-4 img">
                                                <a href="<?php echo e(url('tin-tuc/'.$hotNew->slug.'.html')); ?>"><img src="<?php echo e(url($New->image)); ?>"></a>
                                            </div>
                                            <div class="col-sm-8">

                                                <div class="item-info">
                                                    <h3 class="title-news"><a href="<?php echo e(url('tin-tuc/'.$hotNew->slug.'.html')); ?>"><?php echo e($hotNew->title); ?></a></h3>
