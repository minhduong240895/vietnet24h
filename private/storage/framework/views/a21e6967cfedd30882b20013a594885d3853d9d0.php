<?php $__env->startSection('pageTitle', 'Danh mục con'); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        <?php echo e(Breadcrumbs::render('topics')); ?>
                ...
                <div class="col-xs-12">
                    <div class="card card-data-tables customer-table-wrapper">
                        <header class="card-heading">
                            <h2 class="card-title">Danh sách danh mục con</h2>
    ...
    <script>
        $(function () {
            $('#roomTable').DataTable({
                stateSave: true,
                serverSide: true,
                ajax: '<?php echo route('statistic.gettopic'); ?>',
                processing:     "Loading...",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
