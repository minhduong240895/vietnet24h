<?php $__env->startSection('pageTitle', 'Thêm mới loại bài viết'); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        <?php echo e(Breadcrumbs::render('types-create')); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php echo Form::open(['route' => ['types.store'], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal']); ?>
