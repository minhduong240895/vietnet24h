...
<head>
    ...
    <title>@yield('pageTitle') - Quản trị Admin</title>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/theme-b.css') }}">
                    ...
                    <li class="dropdown avatar-menu">
                        <a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
								<span class="meta">
									<span class="avatar">
                                        @if(Auth::user()->avatar)
                                            <img src="{{url(Auth::user()->avatar)}}" alt="" class="img-circle max-w-35">
                                        @else
                                            <img src="{{url('assets/img/profiles/user.png')}}" alt="" class="img-circle max-w-35">
                                        @endif
                        ...
                        <ul class="dropdown-menu btn-primary dropdown-menu-right">
                            <li>
                                <a href="{{route("users.show", ['id' => Auth::user()->id])}}"><i class="zmdi zmdi-account"></i> Tài khoản</a>
                            </li>
                            <li>
                                <a href="{{route("users.edit", ['id' => Auth::user()->id])}}"><i class="zmdi zmdi-edit"></i> Chỉnh sửa thông tin</a>
                            </li>
                            <li>
                                <a href="{{route("users.logout")}}"><i class="zmdi zmdi-sign-in"></i> Đăng xuất</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="logo_wrapper">
            <ul>
                <li class="logo-icon">
                    <a href="{{'/'}}">
                        <div class="logo">
                            <img src="{{ URL::asset('assets/img/logo/logo-icon@2x.png') }}" alt="Logo">
                        </div>
                    </a>
                </li>
                <li class="menu-icon">
