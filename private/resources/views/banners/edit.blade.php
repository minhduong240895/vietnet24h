@extends('layouts.app')
@section('pageTitle', 'Chỉnh sửa ảnh quảng cáo')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        {{ Breadcrumbs::render('banners-edit', $data) }}
                    </header>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <header class="card-heading ">
                            <h2 class="card-title">{{trans('Thông tin ảnh quảng cáo')}}</h2>
                        </header>
                        <div class="card-body">
                            {!! Form::open(['route' => ['banners.update', 'id' => $data->id], 'files' => true, 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group">
                                {{Form::label('position', trans('Vị trí hiện tại'), ['class' => 'col-sm-2 control-label'])}}
                                <div class="col-sm-10">
                                    {{ Form::text('position-curent', $data->position,
                                            [
                                                'data-rule-required' => 'true',
                                                'minlength' => '2',
                                                'class' => 'form-control',
                            ...
                            <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                                {{Form::label('position', 'Thay đổi vị trí hiển thị', ['class' => 'col-sm-2 control-label'])}}
                                <div class="col-sm-10">
