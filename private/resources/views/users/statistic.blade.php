            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        {{ Breadcrumbs::render('statistic-topic') }}
                    </header>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="card card-data-tables customer-table-wrapper">
                        <header class="card-heading">
                            <h2 class="card-title">Thống kê theo tác giả - {{$user}} </h2>
                            <h2 class="card-title">Tổng nhuận bút - {{number_format($total)}},000 VND </h2>
                            ...
                            <div class="table-responsive">
                                <table id="roomTable" class="mdl-data-table customer-table m-t-30 sweet_alerts_card" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <th>{{number_format($total)}},000 VND</th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
    ...
    <script>
        $(function () {
            $('#roomTable').DataTable({
                stateSave: true,
                serverSide: true,
                ajax: '{!! route('statistic.userdata', ['id'=> $id]) !!}',
                processing:     "Loading...",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: function (data) {
