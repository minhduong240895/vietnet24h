@extends('layouts.app')
@section('pageTitle', 'Thêm mới danh mục con')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        ...
                        {{ Breadcrumbs::render('topics-create') }}
                    </header>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <header class="card-heading ">
                            <h2 class="card-title">{{trans('Thông tin danh mục con')}}</h2>
                        </header>
                        <div class="card-body">
                            {!! Form::open(['route' => ['topics.store'], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal']) !!}
