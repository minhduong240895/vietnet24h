...
<head>
    ...
    <title>@yield('pageTitle') - Motel Management system</title>
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown avatar-menu">
                        ...
                        <ul class="dropdown-menu btn-primary dropdown-menu-right">
                            <li>
                                <a href="{{route("users.edit", ['id' => Auth::user()->id])}}"><i class="zmdi zmdi-account"></i> Profile</a>
                            </li>
                            <li>
                                <a href="{{route("users.logout")}}"><i class="zmdi zmdi-sign-in"></i> Sign Out</a>
                            </li>
                        </ul>
                    </li>
                </ul>
