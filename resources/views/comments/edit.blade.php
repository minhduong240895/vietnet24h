    ...
    <div id="header_wrapper" class="header-md ecom-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <header id="header">
                        <h1>{{trans('Eit Member')}}</h1>
                        {{ Breadcrumbs::render('members-edit', $data) }}
                    </header>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => ['members.update', 'id' => $data->id], 'files' => true, 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="{{url($data->avatar)}}" width="400" height="200" />
                                </div>
                            </div>
