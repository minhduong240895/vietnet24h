    ...
    /***/ (function (module, exports) {
        ...
        var initToolbarjs = function initToolbarjs() {
            ...
            $("#transport-options-2").find('a').on('hover', function () {
                var newthis = $(this);
                var newbutton = $('button[data-toolbar="transport-options-2"]');
                var newClass = newthis.find('i').attr('class').substring(3);
                var oldClass = newbutton.find('i').attr('class').substring(3);
                if (newClass != oldClass) {
                    newbutton.find('i').animate({
                        top: "+=50",
                        opacity: 0
                    }, 200, function () {
    ...
    /***/ (function (module, exports) {
        ...
        var sweetAlerts = function sweetAlerts() {
            ...
            $('#sweet_alerts_card').on('click.sweet-warning', '.sweet-warning', function (e) {
                e.stopPropagation();
                swal({
                    title: "Warning: you want change?",
                    text:  "You will not be able to restore this functionality!",
                    type: "warning",
    ...
    /***/ (function (module, exports) {
        ...
        var wizardDemo = function wizardDemo() {
            ...
            $('#rootwizard .finish').on('click', function (e) {
                e.stopPropagation();
                swal({
                    title: "Order Complete", text: "Thank you for your purchase!", type: "success", timer: 2000,
